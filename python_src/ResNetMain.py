...
if hyperparameters.meta_heuristic != 'none':
    meta_callback = RunMetaHeuristicOnPlateau(
        X=train_x, y=train_y, meta_heuristic=hyperparameters.meta_heuristic, population_size=15, iterations=5,
        monitor='val_loss',  patience=3, verbose=1, mode='min', min_delta=0.001, cooldown=4)
