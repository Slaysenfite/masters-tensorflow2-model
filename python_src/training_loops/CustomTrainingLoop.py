...
def apply_swarm_optimization(X, model, y):
    pso = PsoEnv(swarm_size=15, iterations=10, model=model, X=X, y=y)
...
def run_meta_heuristic(meta_heuristic, prefered_order, meta_heuristic_order, model, train_x, train_y):
